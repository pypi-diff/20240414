# Comparing `tmp/scwrypts-4.2.4.tar.gz` & `tmp/scwrypts-4.2.5.tar.gz`
...
### Comparing `scwrypts-4.2.4/scwrypts/http/linear/test_graphql.py` & `scwrypts-4.2.5/scwrypts/http/linear/test_graphql.py`
