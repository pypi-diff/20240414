# Comparing `tmp/transfa-0.2.3.tar.gz` & `tmp/transfa-0.2.6.tar.gz`
...
+gzip compressed data, was "transfa-0.2.6.tar", last modified: Sun Apr 14 18:05:26 2024, max compression
```

## Comparing `transfa-0.2.3.tar` & `transfa-0.2.6.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/
+-rw-r--r--   0 runner    (1001) docker     (127)    11357 2024-04-14 18:05:22.000000 transfa-0.2.6/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)     5217 2024-04-14 18:05:26.186271 transfa-0.2.6/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     4218 2024-04-14 18:05:22.000000 transfa-0.2.6/README.md
+-rw-r--r--   0 runner    (1001) docker     (127)      275 2024-04-14 18:05:22.000000 transfa-0.2.6/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (127)     1592 2024-04-14 18:05:26.186271 transfa-0.2.6/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-14 18:05:22.000000 transfa-0.2.6/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.182271 transfa-0.2.6/tests/
+-rw-r--r--   0 runner    (1001) docker     (127)     3763 2024-04-14 18:05:22.000000 transfa-0.2.6/tests/test_payment.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2599 2024-04-14 18:05:22.000000 transfa-0.2.6/tests/test_webhook.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.182271 transfa-0.2.6/transfa/
+-rw-r--r--   0 runner    (1001) docker     (127)      348 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2009 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/api_client.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/transfa/api_resources/
+-rw-r--r--   0 runner    (1001) docker     (127)       51 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/api_resources/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2804 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/api_resources/payments.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1727 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/api_resources/webhook.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/transfa/configs/
+-rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/configs/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)       18 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/configs/version.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/transfa/types/
+-rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/types/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)      663 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/types/enums.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/transfa/utils/
+-rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/utils/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)      738 2024-04-14 18:05:22.000000 transfa-0.2.6/transfa/utils/helpers.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-14 18:05:26.186271 transfa-0.2.6/transfa.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     5217 2024-04-14 18:05:26.000000 transfa-0.2.6/transfa.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      577 2024-04-14 18:05:26.000000 transfa-0.2.6/transfa.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-14 18:05:26.000000 transfa-0.2.6/transfa.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-14 18:05:25.000000 transfa-0.2.6/transfa.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (127)       49 2024-04-14 18:05:26.000000 transfa-0.2.6/transfa.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        8 2024-04-14 18:05:26.000000 transfa-0.2.6/transfa.egg-info/top_level.txt
```

### Comparing `transfa-0.2.3/LICENSE` & `transfa-0.2.6/LICENSE`

 * *Files identical despite different names*

### Comparing `transfa-0.2.3/PKG-INFO` & `transfa-0.2.6/PKG-INFO`
...
### Comparing `transfa-0.2.3/README.md` & `transfa-0.2.6/README.md`

 * *Files identical despite different names*

### Comparing `transfa-0.2.3/setup.cfg` & `transfa-0.2.6/setup.cfg`
...
### Comparing `transfa-0.2.3/tests/test_payment.py` & `transfa-0.2.6/tests/test_payment.py`
...
### Comparing `transfa-0.2.3/tests/test_webhook.py` & `transfa-0.2.6/tests/test_webhook.py`
...
### Comparing `transfa-0.2.3/transfa/api_client.py` & `transfa-0.2.6/transfa/api_client.py`
...
### Comparing `transfa-0.2.3/transfa/api_resources/payments.py` & `transfa-0.2.6/transfa/api_resources/payments.py`
...
### Comparing `transfa-0.2.3/transfa/enums.py` & `transfa-0.2.6/transfa/types/enums.py`

 * *Files identical despite different names*

### Comparing `transfa-0.2.3/transfa/utils.py` & `transfa-0.2.6/transfa/utils/helpers.py`

 * *Files identical despite different names*

### Comparing `transfa-0.2.3/transfa/webhook.py` & `transfa-0.2.6/transfa/api_resources/webhook.py`
...
### Comparing `transfa-0.2.3/transfa.egg-info/PKG-INFO` & `transfa-0.2.6/transfa.egg-info/PKG-INFO`
