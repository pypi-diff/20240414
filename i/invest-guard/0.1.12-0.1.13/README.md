# Comparing `tmp/invest_guard-0.1.12.tar.gz` & `tmp/invest_guard-0.1.13.tar.gz`
...
## Comparing `invest_guard-0.1.12.tar` & `invest_guard-0.1.13.tar`
...
### Comparing `invest_guard-0.1.12/PKG-INFO` & `invest_guard-0.1.13/PKG-INFO`
...
### Comparing `invest_guard-0.1.12/README.md` & `invest_guard-0.1.13/README.md`

 * *Files identical despite different names*

### Comparing `invest_guard-0.1.12/invest_guard.egg-info/PKG-INFO` & `invest_guard-0.1.13/invest_guard.egg-info/PKG-INFO`
...
### Comparing `invest_guard-0.1.12/setup.py` & `invest_guard-0.1.13/setup.py`
