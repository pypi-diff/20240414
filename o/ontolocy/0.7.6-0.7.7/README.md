# Comparing `tmp/ontolocy-0.7.6.tar.gz` & `tmp/ontolocy-0.7.7.tar.gz`
...
### Comparing `ontolocy-0.7.6/src/ontolocy/models/threatactor.py` & `ontolocy-0.7.7/src/ontolocy/models/threatactor.py`
