# Comparing `tmp/utrc-0.0.7.tar.gz` & `tmp/utrc-0.0.8.tar.gz`
...
### Comparing `utrc-0.0.7/README.md` & `utrc-0.0.8/README.md`
...
### Comparing `utrc-0.0.7/utrc/_modidx.py` & `utrc-0.0.8/utrc/_modidx.py`
