# Comparing `tmp/pyroblack-2.3.64.tar.gz` & `tmp/pyroblack-2.3.65.tar.gz`
...
### Comparing `pyroblack-2.3.64/Makefile` & `pyroblack-2.3.65/Makefile`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/build-docs.sh` & `pyroblack-2.3.65/build-docs.sh`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/__init__.py` & `pyroblack-2.3.65/compiler/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/__init__.py` & `pyroblack-2.3.65/compiler/api/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/compiler.py` & `pyroblack-2.3.65/compiler/api/compiler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/source/auth_key.tl` & `pyroblack-2.3.65/compiler/api/source/auth_key.tl`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/source/main_api.tl` & `pyroblack-2.3.65/compiler/api/source/main_api.tl`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/source/sys_msgs.tl` & `pyroblack-2.3.65/compiler/api/source/sys_msgs.tl`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/template/combinator.txt` & `pyroblack-2.3.65/compiler/api/template/combinator.txt`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/api/template/type.txt` & `pyroblack-2.3.65/compiler/api/template/type.txt`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/__init__.py` & `pyroblack-2.3.65/compiler/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/compiler.py` & `pyroblack-2.3.65/compiler/errors/compiler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/sort.py` & `pyroblack-2.3.65/compiler/errors/sort.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/400_BAD_REQUEST.tsv` & `pyroblack-2.3.65/compiler/errors/source/400_BAD_REQUEST.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/401_UNAUTHORIZED.tsv` & `pyroblack-2.3.65/compiler/errors/source/401_UNAUTHORIZED.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/403_FORBIDDEN.tsv` & `pyroblack-2.3.65/compiler/errors/source/403_FORBIDDEN.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/406_NOT_ACCEPTABLE.tsv` & `pyroblack-2.3.65/compiler/errors/source/406_NOT_ACCEPTABLE.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/420_FLOOD.tsv` & `pyroblack-2.3.65/compiler/errors/source/420_FLOOD.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv` & `pyroblack-2.3.65/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/__init__.py` & `pyroblack-2.3.65/pyrogram/__init__.py`
...
### Comparing `pyroblack-2.3.64/pyrogram/client.py` & `pyroblack-2.3.65/pyrogram/client.py`
...
### Comparing `pyroblack-2.3.64/pyrogram/dispatcher.py` & `pyroblack-2.3.65/pyrogram/dispatcher.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/emoji.py` & `pyroblack-2.3.65/pyrogram/emoji.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/file_id.py` & `pyroblack-2.3.65/pyrogram/file_id.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/filters.py` & `pyroblack-2.3.65/pyrogram/filters.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/mime_types.py` & `pyroblack-2.3.65/pyrogram/mime_types.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/sync.py` & `pyroblack-2.3.65/pyrogram/sync.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/utils.py` & `pyroblack-2.3.65/pyrogram/utils.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/__init__.py` & `pyroblack-2.3.65/pyrogram/connection/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/connection.py` & `pyroblack-2.3.65/pyrogram/connection/connection.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/__init__.py` & `pyroblack-2.3.65/pyrogram/connection/transport/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/__init__.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp_abridged.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp_abridged.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp_abridged_o.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp_abridged_o.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp_full.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp_full.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp_intermediate.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp_intermediate.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/connection/transport/tcp/tcp_intermediate_o.py` & `pyroblack-2.3.65/pyrogram/connection/transport/tcp/tcp_intermediate_o.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/crypto/__init__.py` & `pyroblack-2.3.65/pyrogram/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/crypto/aes.py` & `pyroblack-2.3.65/pyrogram/crypto/aes.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/crypto/mtproto.py` & `pyroblack-2.3.65/pyrogram/crypto/mtproto.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/crypto/prime.py` & `pyroblack-2.3.65/pyrogram/crypto/prime.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/crypto/rsa.py` & `pyroblack-2.3.65/pyrogram/crypto/rsa.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/__init__.py` & `pyroblack-2.3.65/pyrogram/enums/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/auto_name.py` & `pyroblack-2.3.65/pyrogram/enums/auto_name.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/business_schedule.py` & `pyroblack-2.3.65/pyrogram/enums/business_schedule.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/chat_action.py` & `pyroblack-2.3.65/pyrogram/enums/chat_action.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/chat_event_action.py` & `pyroblack-2.3.65/pyrogram/enums/chat_event_action.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/chat_member_status.py` & `pyroblack-2.3.65/pyrogram/enums/chat_member_status.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/chat_members_filter.py` & `pyroblack-2.3.65/pyrogram/enums/chat_members_filter.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/chat_type.py` & `pyroblack-2.3.65/pyrogram/enums/chat_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/listerner_types.py` & `pyroblack-2.3.65/pyrogram/enums/listerner_types.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/message_entity_type.py` & `pyroblack-2.3.65/pyrogram/enums/message_entity_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/message_media_type.py` & `pyroblack-2.3.65/pyrogram/enums/message_media_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/message_service_type.py` & `pyroblack-2.3.65/pyrogram/enums/message_service_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/messages_filter.py` & `pyroblack-2.3.65/pyrogram/enums/messages_filter.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/next_code_type.py` & `pyroblack-2.3.65/pyrogram/enums/next_code_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/parse_mode.py` & `pyroblack-2.3.65/pyrogram/enums/parse_mode.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/poll_type.py` & `pyroblack-2.3.65/pyrogram/enums/poll_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/profile_color.py` & `pyroblack-2.3.65/pyrogram/enums/profile_color.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/reaction_type.py` & `pyroblack-2.3.65/pyrogram/enums/reaction_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/reply_color.py` & `pyroblack-2.3.65/pyrogram/enums/reply_color.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/sent_code_type.py` & `pyroblack-2.3.65/pyrogram/enums/sent_code_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/stories_privacy_rules.py` & `pyroblack-2.3.65/pyrogram/enums/stories_privacy_rules.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/story_privacy.py` & `pyroblack-2.3.65/pyrogram/enums/story_privacy.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/enums/user_status.py` & `pyroblack-2.3.65/pyrogram/enums/user_status.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/errors/__init__.py` & `pyroblack-2.3.65/pyrogram/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/errors/rpc_error.py` & `pyroblack-2.3.65/pyrogram/errors/rpc_error.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/__init__.py` & `pyroblack-2.3.65/pyrogram/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/bot_business_connect_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/bot_business_connect_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/bot_business_message_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/bot_business_message_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/callback_query_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/chat_join_request_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/chat_join_request_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/chat_member_updated_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/chat_member_updated_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/chosen_inline_result_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/chosen_inline_result_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/conversation_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/conversation_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/deleted_bot_business_messages_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/deleted_bot_business_messages_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/deleted_messages_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/deleted_messages_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/disconnect_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/disconnect_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/edited_bot_business_message_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/edited_bot_business_message_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/edited_message_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/edited_message_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/handler.py` & `pyroblack-2.3.65/pyrogram/handlers/handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/inline_query_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/inline_query_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/message_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/message_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/message_reaction_count_updated_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/message_reaction_count_updated_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/message_reaction_updated_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/message_reaction_updated_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/poll_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/poll_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/raw_update_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/raw_update_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/story_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/story_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/handlers/user_status_handler.py` & `pyroblack-2.3.65/pyrogram/handlers/user_status_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/helpers/__init__.py` & `pyroblack-2.3.65/pyrogram/helpers/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/helpers/helpers.py` & `pyroblack-2.3.65/pyrogram/helpers/helpers.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/advanced/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/advanced/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/advanced/invoke.py` & `pyroblack-2.3.65/pyrogram/methods/advanced/invoke.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/advanced/resolve_peer.py` & `pyroblack-2.3.65/pyrogram/methods/advanced/resolve_peer.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/advanced/save_file.py` & `pyroblack-2.3.65/pyrogram/methods/advanced/save_file.py`
...
### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/auth/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/accept_terms_of_service.py` & `pyroblack-2.3.65/pyrogram/methods/auth/accept_terms_of_service.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/check_password.py` & `pyroblack-2.3.65/pyrogram/methods/auth/check_password.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/connect.py` & `pyroblack-2.3.65/pyrogram/methods/auth/connect.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/disconnect.py` & `pyroblack-2.3.65/pyrogram/methods/auth/disconnect.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/get_password_hint.py` & `pyroblack-2.3.65/pyrogram/methods/auth/get_password_hint.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/initialize.py` & `pyroblack-2.3.65/pyrogram/methods/auth/initialize.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/log_out.py` & `pyroblack-2.3.65/pyrogram/methods/auth/log_out.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/recover_password.py` & `pyroblack-2.3.65/pyrogram/methods/auth/recover_password.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/resend_code.py` & `pyroblack-2.3.65/pyrogram/methods/auth/resend_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/send_code.py` & `pyroblack-2.3.65/pyrogram/methods/auth/send_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/send_recovery_code.py` & `pyroblack-2.3.65/pyrogram/methods/auth/send_recovery_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/sign_in.py` & `pyroblack-2.3.65/pyrogram/methods/auth/sign_in.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/sign_in_bot.py` & `pyroblack-2.3.65/pyrogram/methods/auth/sign_in_bot.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/sign_up.py` & `pyroblack-2.3.65/pyrogram/methods/auth/sign_up.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/auth/terminate.py` & `pyroblack-2.3.65/pyrogram/methods/auth/terminate.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/bots/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/answer_callback_query.py` & `pyroblack-2.3.65/pyrogram/methods/bots/answer_callback_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/answer_inline_query.py` & `pyroblack-2.3.65/pyrogram/methods/bots/answer_inline_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/answer_web_app_query.py` & `pyroblack-2.3.65/pyrogram/methods/bots/answer_web_app_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/delete_bot_commands.py` & `pyroblack-2.3.65/pyrogram/methods/bots/delete_bot_commands.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_bot_commands.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_bot_commands.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_bot_default_privileges.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_bot_info.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_bot_info.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_chat_menu_button.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_game_high_scores.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_game_high_scores.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/get_inline_bot_results.py` & `pyroblack-2.3.65/pyrogram/methods/bots/get_inline_bot_results.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/request_callback_answer.py` & `pyroblack-2.3.65/pyrogram/methods/bots/request_callback_answer.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/send_game.py` & `pyroblack-2.3.65/pyrogram/methods/bots/send_game.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/send_inline_bot_result.py` & `pyroblack-2.3.65/pyrogram/methods/bots/send_inline_bot_result.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/set_bot_commands.py` & `pyroblack-2.3.65/pyrogram/methods/bots/set_bot_commands.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/set_bot_default_privileges.py` & `pyroblack-2.3.65/pyrogram/methods/bots/set_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/set_bot_info.py` & `pyroblack-2.3.65/pyrogram/methods/bots/set_bot_info.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/set_chat_menu_button.py` & `pyroblack-2.3.65/pyrogram/methods/bots/set_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/bots/set_game_score.py` & `pyroblack-2.3.65/pyrogram/methods/bots/set_game_score.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/chats/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/add_chat_members.py` & `pyroblack-2.3.65/pyrogram/methods/chats/add_chat_members.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/archive_chats.py` & `pyroblack-2.3.65/pyrogram/methods/chats/archive_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/ban_chat_member.py` & `pyroblack-2.3.65/pyrogram/methods/chats/ban_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/close_forum_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/close_forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/close_general_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/close_general_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/create_channel.py` & `pyroblack-2.3.65/pyrogram/methods/chats/create_channel.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/create_forum_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/create_forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/create_group.py` & `pyroblack-2.3.65/pyrogram/methods/chats/create_group.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/create_supergroup.py` & `pyroblack-2.3.65/pyrogram/methods/chats/create_supergroup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/delete_channel.py` & `pyroblack-2.3.65/pyrogram/methods/chats/delete_channel.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/delete_chat_photo.py` & `pyroblack-2.3.65/pyrogram/methods/chats/delete_chat_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/delete_forum_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/delete_forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/delete_supergroup.py` & `pyroblack-2.3.65/pyrogram/methods/chats/delete_supergroup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/delete_user_history.py` & `pyroblack-2.3.65/pyrogram/methods/chats/delete_user_history.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/edit_forum_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/edit_forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/edit_general_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/edit_general_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat_event_log.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat_event_log.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat_member.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat_members.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat_members.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat_members_count.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat_members_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_chat_online_count.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_chat_online_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_dialogs.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_dialogs.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_dialogs_count.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_dialogs_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_forum_topics.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_forum_topics.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_forum_topics_by_id.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_forum_topics_by_id.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_nearby_chats.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_nearby_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/get_send_as_chats.py` & `pyroblack-2.3.65/pyrogram/methods/chats/get_send_as_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/hide_general_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/hide_general_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/join_chat.py` & `pyroblack-2.3.65/pyrogram/methods/chats/join_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/join_folder.py` & `pyroblack-2.3.65/pyrogram/methods/chats/join_folder.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/leave_chat.py` & `pyroblack-2.3.65/pyrogram/methods/chats/leave_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/leave_folder.py` & `pyroblack-2.3.65/pyrogram/methods/chats/leave_folder.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/mark_chat_unread.py` & `pyroblack-2.3.65/pyrogram/methods/chats/mark_chat_unread.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/pin_chat_message.py` & `pyroblack-2.3.65/pyrogram/methods/chats/pin_chat_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/promote_chat_member.py` & `pyroblack-2.3.65/pyrogram/methods/chats/promote_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/reopen_forum_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/reopen_forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/reopen_general_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/reopen_general_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/restrict_chat_member.py` & `pyroblack-2.3.65/pyrogram/methods/chats/restrict_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_administrator_title.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_administrator_title.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_description.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_description.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_permissions.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_permissions.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_photo.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_protected_content.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_protected_content.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_title.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_title.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_chat_username.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_chat_username.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_send_as_chat.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_send_as_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/set_slow_mode.py` & `pyroblack-2.3.65/pyrogram/methods/chats/set_slow_mode.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/toggle_folder_tags.py` & `pyroblack-2.3.65/pyrogram/methods/chats/toggle_folder_tags.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/toggle_forum_topics.py` & `pyroblack-2.3.65/pyrogram/methods/chats/toggle_forum_topics.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/toggle_join_to_send.py` & `pyroblack-2.3.65/pyrogram/methods/chats/toggle_join_to_send.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/unarchive_chats.py` & `pyroblack-2.3.65/pyrogram/methods/chats/unarchive_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/unban_chat_member.py` & `pyroblack-2.3.65/pyrogram/methods/chats/unban_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/unhide_general_topic.py` & `pyroblack-2.3.65/pyrogram/methods/chats/unhide_general_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/unpin_all_chat_messages.py` & `pyroblack-2.3.65/pyrogram/methods/chats/unpin_all_chat_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/unpin_chat_message.py` & `pyroblack-2.3.65/pyrogram/methods/chats/unpin_chat_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/chats/update_color.py` & `pyroblack-2.3.65/pyrogram/methods/chats/update_color.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/add_contact.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/add_contact.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/delete_contacts.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/delete_contacts.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/get_contacts.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/get_contacts.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/get_contacts_count.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/get_contacts_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/contacts/import_contacts.py` & `pyroblack-2.3.65/pyrogram/methods/contacts/import_contacts.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_bot_business_connect.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_bot_business_connect.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_bot_business_message.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_bot_business_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_callback_query.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_callback_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_chat_join_request.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_chat_member_updated.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_chosen_inline_result.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_deleted_bot_business_messages.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_deleted_bot_business_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_deleted_messages.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_deleted_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_disconnect.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_disconnect.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_edited_bot_business_message.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_edited_bot_business_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_edited_message.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_edited_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_inline_query.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_message.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_message_reaction_count_updated.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_message_reaction_count_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_message_reaction_updated.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_message_reaction_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_poll.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_poll.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_raw_update.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_raw_update.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_story.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/decorators/on_user_status.py` & `pyroblack-2.3.65/pyrogram/methods/decorators/on_user_status.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/approve_all_chat_join_requests.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/approve_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/approve_chat_join_request.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/approve_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/create_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/create_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/decline_all_chat_join_requests.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/decline_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/decline_chat_join_request.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/decline_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/delete_chat_admin_invite_links.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/delete_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/delete_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/delete_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/edit_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/edit_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/export_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/export_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_admin_invite_links.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_admin_invite_links_count.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_admin_invite_links_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_admins_with_invite_links.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_admins_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_invite_link_joiners.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_invite_link_joiners.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_invite_link_joiners_count.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_invite_link_joiners_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/get_chat_join_requests.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/get_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/invite_links/revoke_chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/methods/invite_links/revoke_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/messages/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/copy_media_group.py` & `pyroblack-2.3.65/pyrogram/methods/messages/copy_media_group.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/copy_message.py` & `pyroblack-2.3.65/pyrogram/methods/messages/copy_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/delete_messages.py` & `pyroblack-2.3.65/pyrogram/methods/messages/delete_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/download_media.py` & `pyroblack-2.3.65/pyrogram/methods/messages/download_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_inline_caption.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_inline_caption.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_inline_media.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_inline_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_inline_reply_markup.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_inline_reply_markup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_inline_text.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_inline_text.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_message_caption.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_message_caption.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_message_media.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_message_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_message_reply_markup.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_message_reply_markup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/edit_message_text.py` & `pyroblack-2.3.65/pyrogram/methods/messages/edit_message_text.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/forward_messages.py` & `pyroblack-2.3.65/pyrogram/methods/messages/forward_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_chat_history.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_chat_history.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_chat_history_count.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_chat_history_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_custom_emoji_stickers.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_custom_emoji_stickers.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_discussion_message.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_discussion_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_discussion_replies.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_discussion_replies.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_discussion_replies_count.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_discussion_replies_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_media_group.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_media_group.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_messages.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_scheduled_messages.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_scheduled_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/get_stickers.py` & `pyroblack-2.3.65/pyrogram/methods/messages/get_stickers.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/inline_session.py` & `pyroblack-2.3.65/pyrogram/methods/messages/inline_session.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/read_chat_history.py` & `pyroblack-2.3.65/pyrogram/methods/messages/read_chat_history.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/retract_vote.py` & `pyroblack-2.3.65/pyrogram/methods/messages/retract_vote.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/search_global.py` & `pyroblack-2.3.65/pyrogram/methods/messages/search_global.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/search_global_count.py` & `pyroblack-2.3.65/pyrogram/methods/messages/search_global_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/search_messages.py` & `pyroblack-2.3.65/pyrogram/methods/messages/search_messages.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/search_messages_count.py` & `pyroblack-2.3.65/pyrogram/methods/messages/search_messages_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_animation.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_animation.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_audio.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_audio.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_cached_media.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_cached_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_chat_action.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_chat_action.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_contact.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_contact.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_dice.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_dice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_document.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_document.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_location.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_location.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_media_group.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_media_group.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_message.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_photo.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_poll.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_poll.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_reaction.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_reaction.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_sticker.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_sticker.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_venue.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_venue.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_video.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_video.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_video_note.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_video_note.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_voice.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_voice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/send_web_page.py` & `pyroblack-2.3.65/pyrogram/methods/messages/send_web_page.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/stop_poll.py` & `pyroblack-2.3.65/pyrogram/methods/messages/stop_poll.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/stream_media.py` & `pyroblack-2.3.65/pyrogram/methods/messages/stream_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/messages/vote_poll.py` & `pyroblack-2.3.65/pyrogram/methods/messages/vote_poll.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/password/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/password/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/password/change_cloud_password.py` & `pyroblack-2.3.65/pyrogram/methods/password/change_cloud_password.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/password/enable_cloud_password.py` & `pyroblack-2.3.65/pyrogram/methods/password/enable_cloud_password.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/password/remove_cloud_password.py` & `pyroblack-2.3.65/pyrogram/methods/password/remove_cloud_password.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/payments/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/payments/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/payments/check_giftcode.py` & `pyroblack-2.3.65/pyrogram/methods/payments/check_giftcode.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/ask.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/ask.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/get_listener_matching_with_data.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/get_listener_matching_with_data.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/get_listener_matching_with_identifier_pattern.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/get_listener_matching_with_identifier_pattern.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/get_many_listeners_matching_with_data.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/get_many_listeners_matching_with_data.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/get_many_listeners_matching_with_identifier_pattern.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/get_many_listeners_matching_with_identifier_pattern.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/listen.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/listen.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/register_next_step_handler.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/register_next_step_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/remove_listerner.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/remove_listerner.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/stop_listener.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/stop_listener.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/stop_listening.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/stop_listening.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/wait_for_callback_query.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/wait_for_callback_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/pyromod/wait_for_message.py` & `pyroblack-2.3.65/pyrogram/methods/pyromod/wait_for_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/stickers/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/stickers/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/stickers/add_sticker_to_set.py` & `pyroblack-2.3.65/pyrogram/methods/stickers/add_sticker_to_set.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/stickers/create_sticker_set.py` & `pyroblack-2.3.65/pyrogram/methods/stickers/create_sticker_set.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/stickers/get_sticker_set.py` & `pyroblack-2.3.65/pyrogram/methods/stickers/get_sticker_set.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/users/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/block_user.py` & `pyroblack-2.3.65/pyrogram/methods/users/block_user.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/check_username.py` & `pyroblack-2.3.65/pyrogram/methods/users/check_username.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/delete_profile_photos.py` & `pyroblack-2.3.65/pyrogram/methods/users/delete_profile_photos.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/delete_stories.py` & `pyroblack-2.3.65/pyrogram/methods/users/delete_stories.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/edit_story.py` & `pyroblack-2.3.65/pyrogram/methods/users/edit_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/export_story_link.py` & `pyroblack-2.3.65/pyrogram/methods/users/export_story_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/forward_story.py` & `pyroblack-2.3.65/pyrogram/methods/users/forward_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_all_stories.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_all_stories.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_chat_photos.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_chat_photos.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_chat_photos_count.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_chat_photos_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_common_chats.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_common_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_default_emoji_statuses.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_default_emoji_statuses.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_me.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_me.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_peer_stories.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_peer_stories.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_stories.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_stories.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_stories_history.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_stories_history.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/get_users.py` & `pyroblack-2.3.65/pyrogram/methods/users/get_users.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/send_story.py` & `pyroblack-2.3.65/pyrogram/methods/users/send_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/set_emoji_status.py` & `pyroblack-2.3.65/pyrogram/methods/users/set_emoji_status.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/set_profile_photo.py` & `pyroblack-2.3.65/pyrogram/methods/users/set_profile_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/set_username.py` & `pyroblack-2.3.65/pyrogram/methods/users/set_username.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/unblock_user.py` & `pyroblack-2.3.65/pyrogram/methods/users/unblock_user.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/update_birthday.py` & `pyroblack-2.3.65/pyrogram/methods/users/update_birthday.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/update_personal_chat.py` & `pyroblack-2.3.65/pyrogram/methods/users/update_personal_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/users/update_profile.py` & `pyroblack-2.3.65/pyrogram/methods/users/update_profile.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/__init__.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/add_handler.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/add_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/compose.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/compose.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/export_session_string.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/export_session_string.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/idle.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/idle.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/remove_handler.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/remove_handler.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/restart.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/restart.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/run.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/run.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/run_sync.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/run_sync.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/start.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/start.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/stop.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/stop.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/methods/utilities/stop_transmission.py` & `pyroblack-2.3.65/pyrogram/methods/utilities/stop_transmission.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/nav/__init__.py` & `pyroblack-2.3.65/pyrogram/nav/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/nav/pagination.py` & `pyroblack-2.3.65/pyrogram/nav/pagination.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/parser/__init__.py` & `pyroblack-2.3.65/pyrogram/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/parser/html.py` & `pyroblack-2.3.65/pyrogram/parser/html.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/parser/markdown.py` & `pyroblack-2.3.65/pyrogram/parser/markdown.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/parser/parser.py` & `pyroblack-2.3.65/pyrogram/parser/parser.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/parser/utils.py` & `pyroblack-2.3.65/pyrogram/parser/utils.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/__init__.py` & `pyroblack-2.3.65/pyrogram/raw/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/__init__.py` & `pyroblack-2.3.65/pyrogram/raw/core/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/future_salt.py` & `pyroblack-2.3.65/pyrogram/raw/core/future_salt.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/future_salts.py` & `pyroblack-2.3.65/pyrogram/raw/core/future_salts.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/gzip_packed.py` & `pyroblack-2.3.65/pyrogram/raw/core/gzip_packed.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/list.py` & `pyroblack-2.3.65/pyrogram/raw/core/list.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/message.py` & `pyroblack-2.3.65/pyrogram/raw/core/message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/msg_container.py` & `pyroblack-2.3.65/pyrogram/raw/core/msg_container.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/tl_object.py` & `pyroblack-2.3.65/pyrogram/raw/core/tl_object.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/__init__.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/bool.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/bool.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/bytes.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/bytes.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/double.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/double.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/int.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/int.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/string.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/string.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/raw/core/primitives/vector.py` & `pyroblack-2.3.65/pyrogram/raw/core/primitives/vector.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/__init__.py` & `pyroblack-2.3.65/pyrogram/session/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/auth.py` & `pyroblack-2.3.65/pyrogram/session/auth.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/session.py` & `pyroblack-2.3.65/pyrogram/session/session.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/internals/__init__.py` & `pyroblack-2.3.65/pyrogram/session/internals/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/internals/data_center.py` & `pyroblack-2.3.65/pyrogram/session/internals/data_center.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/internals/msg_factory.py` & `pyroblack-2.3.65/pyrogram/session/internals/msg_factory.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/internals/msg_id.py` & `pyroblack-2.3.65/pyrogram/session/internals/msg_id.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/session/internals/seq_no.py` & `pyroblack-2.3.65/pyrogram/session/internals/seq_no.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/storage/__init__.py` & `pyroblack-2.3.65/pyrogram/storage/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/storage/file_storage.py` & `pyroblack-2.3.65/pyrogram/storage/file_storage.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/storage/memory_storage.py` & `pyroblack-2.3.65/pyrogram/storage/memory_storage.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/storage/sqlite_storage.py` & `pyroblack-2.3.65/pyrogram/storage/sqlite_storage.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/storage/storage.py` & `pyroblack-2.3.65/pyrogram/storage/storage.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/__init__.py` & `pyroblack-2.3.65/pyrogram/types/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/list.py` & `pyroblack-2.3.65/pyrogram/types/list.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/object.py` & `pyroblack-2.3.65/pyrogram/types/object.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/update.py` & `pyroblack-2.3.65/pyrogram/types/update.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/authorization/__init__.py` & `pyroblack-2.3.65/pyrogram/types/authorization/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/authorization/sent_code.py` & `pyroblack-2.3.65/pyrogram/types/authorization/sent_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/authorization/terms_of_service.py` & `pyroblack-2.3.65/pyrogram/types/authorization/terms_of_service.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/__init__.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_business_connection.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_business_connection.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_chat.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_member.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_command_scope_default.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_command_scope_default.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/bot_info.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/bot_info.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/callback_game.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/callback_game.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/callback_query.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/callback_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/force_reply.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/force_reply.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/game_high_score.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/game_high_score.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/inline_keyboard_button.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/inline_keyboard_button.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/inline_keyboard_markup.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/inline_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/keyboard_button.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/keyboard_button.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/login_url.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/login_url.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/menu_button.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/menu_button.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/menu_button_commands.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/menu_button_commands.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/menu_button_default.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/menu_button_default.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/menu_button_web_app.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/menu_button_web_app.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/reply_keyboard_markup.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/reply_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/reply_keyboard_remove.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/reply_keyboard_remove.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/request_peer_type_channel.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/request_peer_type_channel.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/request_peer_type_chat.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/request_peer_type_chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/request_peer_type_user.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/request_peer_type_user.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/requested_chats.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/requested_chats.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/sent_web_app_message.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/sent_web_app_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/bots_and_keyboards/web_app_info.py` & `pyroblack-2.3.65/pyrogram/types/bots_and_keyboards/web_app_info.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/__init__.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/chosen_inline_result.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_animation.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_animation.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_article.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_article.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_audio.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_audio.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_animation.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_animation.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_audio.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_audio.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_document.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_document.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_photo.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_sticker.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_sticker.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_video.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_video.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_cached_voice.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_cached_voice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_contact.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_contact.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_document.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_document.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_location.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_location.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_photo.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_venue.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_venue.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_video.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_video.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/inline_mode/inline_query_result_voice.py` & `pyroblack-2.3.65/pyrogram/types/inline_mode/inline_query_result_voice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/__init__.py` & `pyroblack-2.3.65/pyrogram/types/input_media/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_animation.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_animation.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_area.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_area.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_area_channel_post.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_area_channel_post.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_audio.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_audio.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_document.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_document.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_photo.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_media_video.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_media_video.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_media/input_phone_contact.py` & `pyroblack-2.3.65/pyrogram/types/input_media/input_phone_contact.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_message_content/__init__.py` & `pyroblack-2.3.65/pyrogram/types/input_message_content/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_message_content/input_message_content.py` & `pyroblack-2.3.65/pyrogram/types/input_message_content/input_message_content.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_message_content/input_reply_to_message.py` & `pyroblack-2.3.65/pyrogram/types/input_message_content/input_reply_to_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_message_content/input_reply_to_story.py` & `pyroblack-2.3.65/pyrogram/types/input_message_content/input_reply_to_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/input_message_content/input_text_message_content.py` & `pyroblack-2.3.65/pyrogram/types/input_message_content/input_text_message_content.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/__init__.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/animation.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/animation.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/audio.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/audio.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/checked_gift_code.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/checked_gift_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/contact.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/contact.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/dice.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/dice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/document.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/document.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/exported_story_link.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/exported_story_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/game.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/game.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/gift_code.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/gift_code.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/giveaway.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/giveaway.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/giveaway_launched.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/giveaway_launched.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/giveaway_result.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/giveaway_result.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/location.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/location.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/media_area.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/media_area.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/media_area_channel_post.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/media_area_channel_post.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/media_area_coordinates.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/media_area_coordinates.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message_entity.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message_entity.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message_reaction_count_updated.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message_reaction_count_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message_reaction_updated.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message_reaction_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message_reactions.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message_reactions.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/message_story.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/message_story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/photo.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/poll.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/poll.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/poll_option.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/poll_option.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/reaction.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/reaction.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/reaction_count.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/reaction_count.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/reaction_type.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/reaction_type.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/sticker.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/sticker.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/stickerset.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/stickerset.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/stories_privacy_rules.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/stories_privacy_rules.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/story.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/story.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/story_deleted.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/story_deleted.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/story_forward_header.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/story_forward_header.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/story_skipped.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/story_skipped.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/story_views.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/story_views.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/stripped_thumbnail.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/stripped_thumbnail.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/thumbnail.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/venue.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/venue.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/video.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/video.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/video_note.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/video_note.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/voice.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/voice.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/web_app_data.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/web_app_data.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/web_page.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/web_page.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/web_page_empty.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/web_page_empty.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/messages_and_media/web_page_preview.py` & `pyroblack-2.3.65/pyrogram/types/messages_and_media/web_page_preview.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/pyromod/identifier.py` & `pyroblack-2.3.65/pyrogram/types/pyromod/identifier.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/pyromod/listener.py` & `pyroblack-2.3.65/pyrogram/types/pyromod/listener.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/__init__.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/__init__.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/birthday.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/birthday.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/business_info.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/business_info.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/business_message.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/business_message.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/business_recipients.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/business_recipients.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/business_weekly_open.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/business_weekly_open.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/business_working_hours.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/business_working_hours.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_admin_with_invite_links.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_admin_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_color.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_color.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_event.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_event.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_event_filter.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_event_filter.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_invite_link.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_join_request.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_join_request.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_joined_by_request.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_joined_by_request.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_joiner.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_joiner.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_member.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_member.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_member_updated.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_permissions.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_permissions.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_photo.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_photo.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_preview.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_preview.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_privileges.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_privileges.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/chat_reactions.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/chat_reactions.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/dialog.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/dialog.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/emoji_status.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/emoji_status.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/forum_topic.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/forum_topic.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/forum_topic_closed.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/forum_topic_closed.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/forum_topic_created.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/forum_topic_created.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/forum_topic_edited.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/forum_topic_edited.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/forum_topic_reopened.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/forum_topic_reopened.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/general_forum_topic_hidden.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/general_forum_topic_hidden.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/general_forum_topic_unhidden.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/general_forum_topic_unhidden.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/invite_link_importer.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/invite_link_importer.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/peer_channel.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/peer_channel.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/peer_user.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/peer_user.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/restriction.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/restriction.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/user.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/user.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/username.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/username.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/video_chat_ended.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/video_chat_ended.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/video_chat_members_invited.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/video_chat_members_invited.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/video_chat_scheduled.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/video_chat_scheduled.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyrogram/types/user_and_chats/video_chat_started.py` & `pyroblack-2.3.65/pyrogram/types/user_and_chats/video_chat_started.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/.gitignore` & `pyroblack-2.3.65/.gitignore`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/COPYING` & `pyroblack-2.3.65/COPYING`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/COPYING.lesser` & `pyroblack-2.3.65/COPYING.lesser`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/NOTICE` & `pyroblack-2.3.65/NOTICE`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/README.md` & `pyroblack-2.3.65/README.md`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/hatch_build.py` & `pyroblack-2.3.65/hatch_build.py`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/pyproject.toml` & `pyroblack-2.3.65/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pyroblack-2.3.64/PKG-INFO` & `pyroblack-2.3.65/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.3 Name: pyroblack Version: 2.3.64 Summary: Pyrogram, but
